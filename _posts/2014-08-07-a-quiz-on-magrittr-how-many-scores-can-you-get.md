...
1. Pipe to first argument and `.`? Give a function name or call.
...
2. Only want to pipe to `.`? Enclose your expression.
...
3. Name the symbol by yourself? Use lambda expression.
